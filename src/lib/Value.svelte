...
<section class="container">
  <header class="header">
    <h2>OUR WORK</h2>
    <p>
      We are committed to enhancing user experiences, exploring innovative
      audience engagement methods, and maximising production efficiency by
      adopting cutting-edge creative technologies.
    </p>
  </header>

  <div class="works-container">
    <div
      class="works works1 {works1Visible
        ? 'slide-in-right'
        : 'before-slide-right'}"
    >
      {#each works1 as work}
    ...
    <div
      class="works works2 {works2Visible
        ? 'slide-in-left'
        : 'before-slide-left'}"
    >
      {#each works2 as work}
