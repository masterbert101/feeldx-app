...
<section class="container">
  <header class="header">
    <h2>Our Services</h2>
    <p>
      FeelDX specialises in crafting immersive visual experiences through
      cutting-edge 3D visualisation and creative technologies. Tailoring
      specialised services to diverse sectors, our niche teams elevate project
      success by aligning with unique client needs. Storytelling is integral,
      woven into our content strategy established through a meticulous discovery
      process, resulting in engaging visual content.
    </p>
  </header>
  ...
  <div class="capability">
    ...
    <header class="capabality-header">
      ...
      <a
        ...
        href="https://www.feeldx.com/capability-statement"
      >
